...
urlpatterns = [
    ...
    path("quick/<str:model_name>/<int:pk>/", views.quick_update, name="quick_update"),
    ...
    path("media/", views.MediaAssetListView.as_view(), name="media_list"),
    path("media/new/", views.MediaAssetCreateView.as_view(), name="media_create"),
    path("media/<int:pk>/edit/", views.MediaAssetUpdateView.as_view(), name="media_edit"),
    path("media/<int:pk>/delete/", views.MediaAssetDeleteView.as_view(), name="media_delete"),
